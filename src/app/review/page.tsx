        ...
        <div className="mx-auto max-w-4xl px-4 py-6">
          ...
          <div className="grid gap-3 sm:grid-cols-4 mb-8">
            <Card><CardContent className="p-4 text-center">
              <p className="text-2xl font-bold">{userStats.todayReviewCards}</p>
              <p className="text-xs text-muted-foreground">待复习</p>
            </CardContent></Card>
            <Card><CardContent className="p-4 text-center">
              <p className="text-2xl font-bold">{userStats.todayNewCards}</p>
              <p className="text-xs text-muted-foreground">新学习</p>
            </CardContent></Card>
            <Card><CardContent className="p-4 text-center">
              <p className="text-2xl font-bold">{userStats.todayCompleted}</p>
              <p className="text-xs text-muted-foreground">已完成</p>
            </CardContent></Card>
            <Card><CardContent className="p-4 text-center">
              <p className="text-2xl font-bold">{Math.round((userStats.todayCompleted / userStats.todayTotal) * 100)}%</p>
