...
[![Vercel](https://img.shields.io/badge/deployed%20on-Vercel-black?logo=vercel)](https://jlpt-grammar-cards.vercel.app)
[![License](https://img.shields.io/badge/license-MIT-blue)](./LICENSE)

一个 Anki 风格的 JLPT（N1–N5）日语语法学习工具。

**在线访问**: https://jlpt-grammar-cards.vercel.app

## 功能

- **语法库** — 浏览 680+ 条 JLPT 语法，支持搜索和筛选
